<?php
// URL: www.procontactforms.com
// Version: Responsive Contact Form with Bootstrap V1.0 - Installer
// Copyright (c) 2019
// 
...
define('JSFILE', 'formValidator-'.date("His").'.js');
...
if (isset($_POST['EMAIL'])) {
    installForm($config_template, $form_template, $js_template, $install_complete, $fields);
    exit();
}


function installForm($config_template, $form_template, $js_template, $install_complete, $fields) {

    global $error_strings;
    
    createJsFile($js_template);
    createHtmlFile($form_template);
...
function createJsFile($js_template) {
    $search = array();
    $replace = array();

    if(isset($_POST['SHOWPHONE']) && $_POST['SHOWPHONE'] == "yesrequired") {
        $search[] = "{PHONE}";
        $replace[] = "
        Phone: {
            validators: {
    ...
    if(isset($_POST['SHOWCOMPANY']) && $_POST['SHOWCOMPANY'] == "yesrequired") {
        $search[] = "{COMPANY}";
        $replace[] = "
        Company: {
            validators: {
    ...
    createFile($search, $replace, $js_template, ABSPATH . JSFILE);

}


function createHtmlFile($form_template) {
    ...
    if(isset($_POST['SHOWPHONE']) && $_POST['SHOWPHONE'] == "yesoptional") {
        $search[] = "{PHONE}";
        $replace[] = '<div class="form-group">
    ...
    } elseif(isset($_POST['SHOWPHONE']) && $_POST['SHOWPHONE'] == "yesrequired") {
        $search[] = "{PHONE}";
        $replace[] = '<div class="form-group">
        <label for="Phone" class="col-sm-2 control-label">Phone</label>
        <div class="col-sm-10">
    ...
    if(isset($_POST['SHOWCOMPANY']) && $_POST['SHOWCOMPANY'] == "yesoptional") {
        $search[] = "{COMPANY}";
        $replace[] = '<div class="form-group">
    ...
    } elseif(isset($_POST['SHOWCOMPANY']) && $_POST['SHOWCOMPANY'] == "yesrequired") {
        $search[] = "{COMPANY}";
        $replace[] = '<div class="form-group">
        <label for="Company" class="col-sm-2 control-label">Company</label>
        <div class="col-sm-10">
...
<html lang="en">
    <head>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.2/js/bootstrapValidator.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
        <script src="formValidatorInstallation.js"></script>
        ...
        <div style="width:98%;max-width:550px;">
            <form id="installationForm" class="form-horizontal" method="post" action="<?php echo INSTALLFILE; ?>">
                <fieldset class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="SHOWPHONE" class="col-sm-3 control-label">Show Phone Field</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list-ul fa-fw"></i></span>
                                <select id="SHOWPHONE" name="SHOWPHONE" class="form-control">
                                    <option value="no">No</option>
                                    <option value="yesoptional">Yes, Optional</option>
                                    <option value="yesrequired">Yes, Required</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="SHOWCOMPANY" class="col-sm-3 control-label">Show Company Field</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list-ul fa-fw"></i></span>
                                <select id="SHOWCOMPANY" name="SHOWCOMPANY" class="form-control">
                                    <option value="no">No</option>
                                    <option value="yesoptional">Yes, Optional</option>
                                    <option value="yesrequired">Yes, Required</option>
                                </select>
